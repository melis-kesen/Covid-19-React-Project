...
var createConnectedRouter = function createConnectedRouter(structure) {
    ...
    _createClass(ConnectedRouter, [{
      ...
      value: function render() {
        var _this$props = this.props,
            ...
            AnyRouter = _this$props.AnyRouter; // The `omitRouter` option is available for applications that must
        ...
        if (AnyRouter) {
          return /*#__PURE__*/_react["default"].createElement(AnyRouter, {
            history: history
          }, children);
        }
  ...
  ConnectedRouter.propTypes = {
    ...
    AnyRouter: _propTypes["default"].object,
